  ...
  return (
    <section id="results" className="relative py-32 px-6 lg:px-10 max-w-6xl mx-auto">
      ...
      >
        ...
        <span className="absolute top-6 left-1/2 -translate-x-1/2 text-[10px] uppercase tracking-[0.3em] glass-card rounded-full px-4 py-2 text-ivory">Drag to Compare</span>
        <span className="absolute bottom-6 left-6 text-[10px] uppercase tracking-[0.3em] glass-card rounded-full px-4 py-2 text-ivory">Before</span>
        <span className="absolute bottom-6 right-6 text-[10px] uppercase tracking-[0.3em] bg-primary text-primary-foreground rounded-full px-4 py-2">After — 14 Days</span>
